...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-r from-blue-600 to-violet-600 py-20 text-white overflow-hidden">
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">두 세계를 연결하는 플랫폼</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card>
              <CardHeader>
                ...
                <CardTitle>지역 기반 타겟 마케팅</CardTitle>
                <CardDescription>
                  정확한 위치 기반 잠재고객 접근
                </CardDescription>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                ...
                <CardTitle>미용실 특화 솔루션</CardTitle>
                <CardDescription>
                  미용업계를 위해 설계된 맞춤형 기능
                </CardDescription>
              </CardHeader>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl font-bold mb-6">미용실 원장님을 위한<br />올인원 솔루션</h2>
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={i} className="flex items-start">
                    <div className="mr-3 mt-1 w-5 h-5 bg-blue-100 rounded-full flex items-center justify-center">
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-16 items-center">
          <div className="order-2 md:order-1 bg-gray-200 rounded-lg aspect-video flex items-center justify-center">
            <Image
            ...
            <div className="order-1 md:order-2">
              <h2 className="text-3xl font-bold mb-6">광고주를 위한<br />정밀 타겟팅 솔루션</h2>
              <p className="text-lg text-gray-600 mb-8">
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={i} className="flex items-start">
                    <div className="mr-3 mt-1 w-5 h-5 bg-purple-100 rounded-full flex items-center justify-center">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">파트너들의 이야기</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
